...
HD_PWD='F:/FPGA Projects/led_blinker/led_blinker.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blinker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_blinker.tcl -notrace
