...
HD_PWD='F:/FPGA Projects/led_blinker/led_blinker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blinker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_blinker.tcl
