...
// The module takes an 8-bit input byte and returns an 8-bit output byte after substitution 
// according to the AES Rijndael S-Box.
// 
//////////////////////////////////////////////////////////////////////////////////
...
module aes_sbox(
    ...
    // S-Box lookup: https://en.wikipedia.org/wiki/Rijndael_S-box
    // This array defines the AES Rijndael S-Box, which is used for byte substitution during encryption and decryption.
    // Each entry corresponds to a unique 8-bit value that is used to replace the original byte.
    // The values are predefined and are part of the AES standard.
